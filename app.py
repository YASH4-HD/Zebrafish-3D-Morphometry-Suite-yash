...
if uploaded_file:
    ...
    with col_left:
        ...
        # Creating a professional 3D Scatter plot
        fig_3d = px.scatter_3d(
            ...
            title="3D Nuclei Map (Colored by Volume)"
        )
    ...
    st.image("https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Zebrafish_embryo.jpg/1200px-Zebrafish_embryo.jpg", caption="Zebrafish Embryo - Model Organism for Developmental Biology")
